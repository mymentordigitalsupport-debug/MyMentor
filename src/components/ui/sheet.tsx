  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        {showClose && (
          <SheetPrimitive.Close className="absolute top-5 right-5 rounded-full transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:ring-offset-background disabled:pointer-events-none">
